...
arm-trusted-firmware-sunxi/build/sun50iw1p1/release/bl31.bin: arm-trusted-firmware-sunxi
	make -C $< CROSS_COMPILE="$(LINARO_CC)" PLAT=sun50iw1p1 bl31

arm-trusted-firmware-sunxi/build/sun50iw1p1/debug/bl31.bin: arm-trusted-firmware-sunxi
...
tmp/u-boot-sunxi-%/spl/sunxi-spl.bin tmp/u-boot-sunxi-%/u-boot.itb: tmp/u-boot-sunxi-%/.config \
	arm-trusted-firmware-sunxi/build/sun50iw1p1/debug/bl31.bin
...
tmp/u-boot-sunxi-%/u-boot-with-spl.bin: tmp/u-boot-sunxi-%/spl/sunxi-spl.bin \
	tmp/u-boot-sunxi-%/u-boot.itb
	cat $^ > $@.tmp
	mv $@.tmp $@
